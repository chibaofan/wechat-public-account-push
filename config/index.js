export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx2bbf29bd557c7dac",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8f2ed3f823fd5c5b564baed3f34a3adf",
   ...
   */
  USERS: [oWSGO56mOQklCojWCsujd8Mc5gys,oWSGO5-SBUPaVy5VZMzxaLi-H3G8]
    {
      // 想要发送的人的名字
      name: "宝宝",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "wxid_stvfjdgztee422",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "e4ZBb4AZ-xgp-T5AfeHpTG0dzEThE123msReIfQ1LXQ",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "保定",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "佳佳", "year": "2003", "date": "01-13"},
        {"type": "生日", "name": "子帅", "year": "2003", "date": "08-13"},
      ],
